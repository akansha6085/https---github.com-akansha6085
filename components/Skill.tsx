...
function Skill({ directionLeft}: Props) {
  return (
    <div className="group relative flex cursor-pointer">
        ...
        className="rounded-full border border-gray-500 h-24 w-24 md:h-28 xl:w-32 xl:h-32 inset-0 object-cover object-center filter group-hover:grayscale transition duration-300 ease-in-out"
        />
